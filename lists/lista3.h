...
public:
    ...
    int mostrar(void funcionMostrar(DATOS d, int r));// muestra la lista 
    DATOS **mostrar();//retorna de forma de arreglo de punteros la lista 
    //inserta en la lista el dato d de forma ordenada
    int insertar(DATOS d, void funcionInsertar(DATOS d), bool funcionOrdenamiento(DATOS nuevo, DATOS insertado, char tipo_orden));
    ...
    int insertarMultiple( void funcionInsertar(DATOS d), bool funcionOrdenamiento(DATOS nuevo, DATOS insertado, char tipo_orden), int numero, ...);
    ...
    DATOS **buscarAll(DATOS d, bool funcionBuscarAllLista(DATOS d, DATOS a_buscar));
    
    bool eliminar(DATOS d, bool funcionEliminarLista(DATOS d, DATOS a_eliminar));
    int eliminarAll(DATOS d, bool funcionEliminarAllLista(DATOS d, DATOS a_eliminar));
