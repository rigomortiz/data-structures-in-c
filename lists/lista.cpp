...
int ListaDoble::insertar(DATOS datos_insertar, funcionLista funcionInsertar(DATOS d), bool funcionOrdenamiento(DATOS nuevo, DATOS insertado, char tipo_orden))
{
	ENLACE nuevo;
	ENLACE head, tmp;
	unsigned int r = 0;
...
int ListaDoble::mostrar(funcionLista funcionMostrarLista(DATOS d, int r))
{
...
int ListaDoble::insertarMultiple(funcionLista funcionInsertar(DATOS d),bool funcionOrdenamiento(DATOS nuevo, DATOS insertado, char tipo_orden), int numero, ...)
{
	int i = 0;
	int r = 1;
	va_list lt;
